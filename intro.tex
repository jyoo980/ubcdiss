...
It has never been easier for software developers to write programs.
...
implementations.
These are only a few tools in the arsenal of the modern software developer.
...
Developers also spend a large amount of time analyzing new problems and 
mapping out broad flows of code used to solve a problem, and understanding
code, such as reasoning aboout the inputs and outputs of a method, determining

Next paragraph:

Talk about how developers actually don't spend most of their time writing code.
Most development time is spent understanding how code works (citation needed).
Tools today are still pretty shit at supporting this type of workflow
(although they exist!).
